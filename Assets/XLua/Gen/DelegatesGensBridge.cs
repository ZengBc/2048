...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp11(float p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(LuaManager.DelegateEmpty))
			{
			    return new LuaManager.DelegateEmpty(__Gen_Delegate_Imp0);
			}
		    ...
		    if (type == typeof(LuaManager.DelegateString))
			{
			    return new LuaManager.DelegateString(__Gen_Delegate_Imp2);
			}
		    ...
		    if (type == typeof(LuaManager.DelegateBool))
			{
			    return new LuaManager.DelegateBool(__Gen_Delegate_Imp10);
			}
		
		    if (type == typeof(LuaManager.DelegateFloat))
			{
			    return new LuaManager.DelegateFloat(__Gen_Delegate_Imp11);
			}
